...
import { Store, Home, LogIn } from "lucide-react";
import { motion } from "framer-motion";

export default function NotAuthorizedStoreAdmin() {
  return (
    <div className="min-h-screen bg-neutral-900 flex items-center justify-center px-4">
      ...
      >
        ...
        <p className="text-neutral-400 mb-6">
          You do not have the required permissions to access the Store Admin
          Dashboard. Please verify your credentials or contact support for
          assistance.
        </p>

        <div className="flex justify-center space-x-4">
          <Link
            href="/login-store-admin"
